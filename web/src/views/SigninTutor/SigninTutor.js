...
import signinTutorPageStyle from "./signinTutorStyle.js";
...
import { signInTutor } from "../../store/actions";
import strings from "constants/strings";
import ErrorModal from "components/ErrorModal/ErrorModal.js";
import Loading from "components/Loading/Loading.js";

const useStyles = makeStyles(signinTutorPageStyle);

export default function SigninTutor({ ...rest }) {
  ...
  const handleSigninTutor = async () => {
    ...
    if (isFormValid) {
      ...
      try {
        await dispatch(signInTutor(signInInfo));
        history.push("/");
      } catch (err) {
        ...
        <div className={classes.container}>
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={8}>
              <Card className={classes.cardSigninTutor}>
